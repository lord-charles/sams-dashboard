...
export function NoBudgets({
  ...
  return (
    <div className="px-4 py-6 bg-gradient-to-b from-primary/5 to-background min-h-screen">
      <motion.div
      ...
      >
        ...
        >
          No {tab} Data Available for {selectedYear}
        </motion.h2>
        <motion.p
          variants={itemVariants}
          className="text-muted-foreground mb-8 text-lg"
        >
          We couldn&apos;t find any {tab} information for the selected year.
        ...
        >
          <li>The {tab} for this year hasn&apos;t been submitted yet</li>
              ...
              {showHelp && (
                ...
                >
                  <ol className="list-decimal list-inside space-y-2 mb-4">
                    <li>Check if you have selected the correct year</li>
