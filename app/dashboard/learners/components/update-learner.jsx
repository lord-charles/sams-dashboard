    ...
    <div className="p-6 flex min-h-screen w-screen bg-gradient-to-b from-primary/20 to-background flex-col md:w-[87%] lg:w-full md:ml-[80px] lg:ml-0 sm:ml-0 overflow-x-hidden rounded-md ">
      ...
      <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-3 lg:gap-8">
        ...
        <div className="grid auto-rows-max items-start gap-4">
              ...
              <div className="grid gap-4">
                <div className="grid lg:grid-cols-3 sm:grid-cols-1 gap-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Select onValueChange={(value) => handleStatusUpdate('promoted', value)}>
                      <SelectTrigger className="w-[140px]" disabled={isLoading}>
                        <SelectValue placeholder={getLatestStatus(learner?.progress, "Promoted")} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
                          <SelectLabel>Promoted | Demoted</SelectLabel>
                          <SelectItem value="Yes" >Yes(promote)</SelectItem>
                          <SelectItem value="No">No(demote)</SelectItem>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Select onValueChange={(value) => handleStatusUpdate('repeated', value)}>
                      <SelectTrigger className="w-[140px]" disabled={isLoading}>
                        <SelectValue placeholder={getLatestStatus(learner?.progress, "Repeated")} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
                          <SelectLabel>Repeated</SelectLabel>
                          <SelectItem value="Yes" >Yes</SelectItem>
                          <SelectItem value="No">No</SelectItem>
          ...
          <LearnerProgressCard progress={learner?.progress || []} learnerUniqueID={learner?.learnerUniqueID} reference={learner?.reference} />
        </div>
      </div>
