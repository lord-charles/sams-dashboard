...
import { gender, qualification, workStatus } from "../data/data";
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        ...
        {table.getColumn("workStatus") && (
          <DataTableFacetedFilter
            column={table?.getColumn("workStatus")}
            title="Work Status"
            options={workStatus}
          />
        )}
        {table.getColumn("professionalQual") && (
          <DataTableFacetedFilter
            column={table?.getColumn("professionalQual")}
            title="Qualification"
